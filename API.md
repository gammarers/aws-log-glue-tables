...
| <code><a href="#@gammarers/aws-log-glue-tables.BucketStaticWebHostingAccessLogTable.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gammarers/aws-log-glue-tables.BucketStaticWebHostingAccessLogTable.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gammarers/aws-log-glue-tables.BucketStaticWebHostingAccessLogTable.with.parameter.mixins"></a>
...
| <code><a href="#@gammarers/aws-log-glue-tables.CloudFrontAccessLogTable.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gammarers/aws-log-glue-tables.CloudFrontAccessLogTable.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gammarers/aws-log-glue-tables.CloudFrontAccessLogTable.with.parameter.mixins"></a>
